package com.lyc.rabbitmqspring;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.lyc.rabbitmqspring.entity.Order;
import com.lyc.rabbitmqspring.entity.Packaged;
...
public class RabbitmqSpringApplicationTests {
	...
	public void testSendMessage(){
		...
		Message message=new Message("He来咯RabbitMQ".getBytes(),messageProperties);
		rabbitTemplate.convertAndSend("topic001", "spring.amqp", message, new MessagePostProcessor() {
			@Override
			public Message postProcessMessage(Message message) throws AmqpException {
				System.out.println("----添加额外设置-------");
				message.getMessageProperties().getHeaders().put("desc","额外修改的信息描述");
				message.getMessageProperties().getHeaders().put("attr","额外添加属性");
